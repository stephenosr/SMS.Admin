...
namespace SMS.SyncCommunicator
{
    public class Communicator
    {
        ...
        public async static Task<HttpResponseMessage> InvokeFeeRegister(SyncFeeDetails Parameters, string ServiceName)
        {
        ...
        public async static Task<HttpResponseMessage> InvokeFeePull(Guid Parameters, string ServiceName)
        {
            HttpResponseMessage ResponseResult = null;
